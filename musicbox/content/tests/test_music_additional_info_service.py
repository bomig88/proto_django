...
class TestMusicDetailService(TestCase):
    ...
    def test_create(self, params=None):
        ...
        serializer = self.music_additional_info_service.create(params)
    ...
    def test_modify(self, path_param=None, modify_params=None):
        ...
        serializer = self.music_additional_info_service.modify(
    ...
    def test_select(self, params=None):
        ...
        serializer = self.music_additional_info_service.select(path_param=params)
    ...
    def test_select_model(self, params=None):
        ...
        model = self.music_additional_info_service.select_model(path_param=params)
    ...
    def test_select_all(self, params=None):
        ...
        serializer = self.music_additional_info_service.select_all(params=params)
