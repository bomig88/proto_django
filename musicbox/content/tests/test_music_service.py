...
from content.tests.test_music_additional_info_service import TestMusicAdditionalInfoService
...
class TestMusicService(TestCase):
    ...
    def test_create(self, params=None):
        if not params:
            params = dict()
            params['name'] = 'I Am'
            params['play_time'] = 312
            params['price'] = 700

            album_instance = self.test_album_service.test_create()
            params['album_seq'] = album_instance['seq']

            music_additional_info_seq_instance = self.test_music_additional_info_service.test_create()
            params['music_additional_info_seq'] = music_additional_info_seq_instance['seq']

        print('params')
        print(params)

        serializer = self.music_service.create(params)
    ...
    def test_modify(self, path_param=None, modify_params=None):
        ...
        serializer = self.music_service.modify(
    ...
    def test_select(self, params=None):
        ...
        serializer = self.music_service.select(path_param=params)
    ...
    def test_select_model(self, params=None):
        ...
        model = self.music_service.select_model(path_param=params)
    ...
    def test_select_all(self, params=None):
        ...
        serializer = self.music_service.select_all(params=params)
